...
def createConfig() {
    ...
    dynamicPage(name: "createConfig", title: "Configuration", install:true, uninstall:true) {
        section ("Allow external service to control these things...") {
            ...
            input "thermostats", "capability.temperatureMeasurement", multiple: true, required: false, title:"Which Device?", description:"Select the devices you want Tibber to have access to."
        }
    }
}
def installed() {
